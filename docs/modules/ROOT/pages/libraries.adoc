...
### `datasonnet(string expression)`
Evaluates and returns the result of a valid DataSonnet expression.

*Example*

In this example payload is a DataSonnet mapping. This mapping is evaluated in the main map and the result is assigned to another field.
...
------------------------
{
    evaluatedValue: DS.Lang.datasonnet(payload)
}
------------------------
.Result
------------------------
